INSERT INTO source_file (
    source_base_id, agency_base_id, url, page_title, original_data_url, original_metadata_url,
    last_scraped_at, originally_scraped, original_data_hash, type, status
)
VALUES (
    :source_base_id::UUID, :agency_base_id::UUID, :url, :page_title, :original_data_url, :original_metadata_url,
