...
VALUES (
    :source_base_id::UUID, :url, :page_title, :original_data_url, :scraped_at::TIMESTAMP WITH TIME ZONE, :scraped_at::TIMESTAMP WITH TIME ZONE, 'scraped_file'::source_file_type
)
